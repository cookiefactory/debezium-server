...
#
ENV DEBEZIUM_VERSION=3.2.0-SNAPSHOT \
...
ENV SERVER_URL_PATH=io/debezium/debezium-server-dist/$DEBEZIUM_VERSION/debezium-server-dist-$DEBEZIUM_VERSION.tar.gz \
    SERVER_MD5=53c31241666baf3d1972a6facf54a50b
...
#
# Copy Debezium Server
#
# RUN curl -fSL -o /tmp/debezium.tar.gz "$MAVEN_REPO_CENTRAL/$SERVER_URL_PATH"
COPY --chown=jboss:jboss debezium-server-dist/target/debezium-server-dist-$DEBEZIUM_VERSION.tar.gz /tmp/debezium.tar.gz

#
# Verify the contents and then install ...
#
# RUN ls -lh /tmp/debezium.tar.gz 
